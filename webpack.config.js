...
module.exports = function build( parameter ){
	...
	return {
		"entry": parameter.test? "./test.js" : "./form-footer.support.js",
		...
		"output": {
			"library": parameter.test? "test" : "form-footer",
			"libraryTarget": "umd",
			"filename": parameter.test? "test.deploy.js" : "form-footer.deploy.js"
		},
